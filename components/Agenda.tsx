        ...
        try {
            ...
            if (newStatus && originalItem.unidade) {
                ...
                if (unitData && unitData.empresaid) {
                    ...
                    // Parse defensivo: garante que exames_snapshot seja sempre um array.
                    // O Supabase pode retornar a coluna como string JSON caso o tipo no banco
                    // seja 'text' ao invés de 'jsonb', o que causaria apenas o primeiro exame
                    // ser salvo na tabela financeiro_receitas.
                    ...
                    if (Array.isArray(rawSnapshot)) {
                        ...
                        try {
                            ...
                            // Se o parse falhar, mantém o array vazio (erro ignorado intencionalmente)
                            examesParaInserir = [];
                        }
                    }
