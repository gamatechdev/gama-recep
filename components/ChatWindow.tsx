      ...
      <div className="flex items-center gap-3 flex-1">
          ...
          <button
            ...
            className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 transition-all ${
              isOwn ? 'text-white/90 hover:text-white' : 'text-slate-500 hover:text-slate-700 dark:text-slate-300 dark:hover:text-white'
            }`}
          >
            {isPlaying ? (
          ...
          <div className="flex flex-col justify-center flex-1 min-w-0">
             <input
              ...
              className={`w-full h-1.5 rounded-full appearance-none cursor-pointer focus:outline-none ${
                 isOwn ? 'bg-[#149890]/40 accent-white' : 'bg-slate-300 dark:bg-white/20 accent-[#04a7bd]'
              }`}
              style={{
                  ...
                  return (
                    ...
                    >
                        ...
                        >
                            ...
                            {replyId && (
                               <div className={`mb-2 rounded-lg p-2 text-xs border-l-4 cursor-pointer select-none ${
                                   isOwn 
                                ...
                                <div className="mb-2">
                                    <a 
                                        ...
                                        className={`flex items-center gap-3 p-3 rounded-xl transition-colors ${
                                            isOwn ? 'bg-[#04a7bd] hover:bg-[#149890]' : 'bg-slate-50 dark:bg-white/5 hover:bg-slate-100 dark:hover:bg-white/10'
                                        }`}
                                    >
